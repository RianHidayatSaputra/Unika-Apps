    ...
    <div class="container">
        <div class="row mt-5 border-bottom">
            <div class="col-xl-3">
                ...
                <a href="#" class="fs-6 lh-lg text-decoration-none text-dark">About Us <br> Latest Post <br> Contact
                    Us <br> Shop</a>
            </div>
            <div class="col-xl-3 mb-5">
                <h6 class="fs-6 mt-5 mb-3 fw-bold">HELP LINKS</h6>
                <a href="#" class="fs-6 lh-lg text-decoration-none text-dark">Tracking <br> Order Status <br>
                    Delivery <br> Shipping Info <br> FAQ</a>
            </div>
            <div class="col-xl-3">
                <h6 class="fs-6 mt-5 mb-3 fw-bold">USEFUL LINKS</h6>
                <a href="#" class="fs-6 lh-lg text-decoration-none text-dark">Special Offers <br> Gift Cards <br>
                    Advertising <br> Terms Of Use</a>
            </div>
            <div class="col-xl-3">
                <h6 class="fs-6 mt-5 mb-3 fw-bold">GET IN THE KNOW</h6>
                <form action="#" method="post">
                    <input type="email" name="email" id="email" placeholder="Enter email"
                        class="border-bottom bg-light mt-3"><i class="bi bi-caret-right"></i>
                </form>
            </div>
        </div>
