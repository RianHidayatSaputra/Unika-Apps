...
<h6 class="text-center fs-3 mt-4 mb-2 fw-bold">Discover New Arrival</h6>col-xl
...
<div class="container">
    <div class="row mt-5 mb-3">
        <div class="col-xl-3">
            ...
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Plain White Shirt</p></a>
            <p class="text-center dolar text-primary">$29.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-2.png')}}" alt="gambar 2" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Denim Jacket</p></a>
            <p class="text-center dolar text-primary">$69.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-3.png')}}" alt="gambar 3" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Black Polo Shirt</p></a>
            <p class="text-center dolar text-primary">$49.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-4.png')}}" alt="gambar 4" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Blue Sweatshirt</p></a>
    ...
    <div class="row mb-5">
        <div class="col-xl-3">
            ...
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Blue Plain Shirt</p></a>
            <p class="text-center dolar text-primary">$49.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-6.png')}}" alt="gambar 6" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Dark Blue Shirt</p></a>
            <p class="text-center dolar text-primary">$89.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-7.png')}}" alt="gambar 7" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Outcast T Shirt</p></a>
            <p class="text-center dolar text-primary">$19.00</p>
        </div>
        <div class="col-xl-3">
            <img src="{{asset('assets/img/img-8.png')}}" alt="gambar 8" class="img-fluid">
            <a href="#" class="text-decoration-none text-dark"><p class="text-center nama-products fw-bold mt-3">Polo Plain Shirt</p></a>
            <p class="text-center dolar text-primary">$29.00</p>
        </div>
    </div>
