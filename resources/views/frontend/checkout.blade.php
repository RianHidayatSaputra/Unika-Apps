    ...
    <div class="container pt-5 cart">
        <div id="popup" class="w-100">
            <div class="row pt-5 mb-2">
                <p class="home-checkout"><a href="/home"
                        class="text-secondary text-decoration-none home-checkout">HOME</a>/CHECKOUT</p>
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label for="street-address" class="form-label">Street address<i
                                class="text-danger">*</i></label><br>
                        <input class="border py-2 px-3 w-50" type="text" id="street-address" name="street-address"
            ...
            <div class="row p-4 mb-5 border">
                <div class="col-xl-12 bg-light p-2">
                    <p class="text-secondary">Cash on delivery. Please contact us if you require assistance or wish to make
                        alternate arrangements.</p>
                </div>
                <div class="col-xl-12 d-flex justify-content-end">
                    <button type="submit" class="px-4 py-2 fs-6 mt-4 text-white place-order" onclick="popUp()">PLACE
                        ORDER</button>
                </div>
            </div>
            </form>
