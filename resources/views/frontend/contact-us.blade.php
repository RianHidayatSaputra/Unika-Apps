        ...
        <div class="row mt-5">
                ...
                <form action="/message/send" method="post">
                    <div class="input d-flex">
                        ...
                        <div class="input-email w-50">
                            ...
                            <input type="email" name="email" id="email" class="form-control ms-1" required>
                        </div>
                    </div>
            ...
            <div class="col-xl-3">
                ...
                <p class="Recently mb-4">You can get in touch with us on this provided email.
                    <br><br>Email:hmjawad087@gmail.com
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ganti = () => {
            ...
            var text = `<h1 class="text-center">
                    ...
                    <a href="/home" class="text-white text-decoration-none px-4 py-2 bg-primary">Go Back</a>
                `
